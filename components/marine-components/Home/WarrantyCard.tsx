...
function WarrantyCard({productImage,brandImage,description}:WarrentyCard) {
  return (
    <section className=' max-w-[350px] mx-auto sm:w-full relative h-auto bg-transparent rounded-lg p-3 md:p-5  '>

        <div className='w-full relative flex items-start flex-col h-auto  '>
                <Image src={productImage} alt='product image' height={500} width={500} className='w-[100px] h-auto self-end -mt-6 lg:-mt-10 '/>
