...
function CompnainForm() {
  return (
    <form action="" className="w-full relative h-auto border p-5 ">
      <span className="w-full relative h-auto flex flex-col gap-3">
        <h2 className="text-3xl font-medium text-foreground ">
          Complaint Form
        </h2>
        <p className="text-base font-medium text-secondary">
          Please use the form below to share your concern with us and we will
          come back to you with the right solution
        </p>
      </span>
