...
export default function CareersForm() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-6 bg-lightgray ">
      <div className="mb-8 space-y-2">
        <h1 className="text-2xl font-bold text-primary">Career</h1>
        <p className="text-gray-600">
          Looking for a place where your ideas matter? At Brainmine, we give you the platform to innovate, learn, and
          excel in your career. Apply now and turn your ambitions into achievements!
        </p>
      </div>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="space-y-4">
            <h2 className="text-lg text-primary  font-medium">Personal Information</h2>
          ...
          {/* Position & Experience */}
          <div className="space-y-4">
            <h2 className="text-lg text-primary font-medium">Position & Experience</h2>
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
                control={form.control}
                name="jobRole"
          ...
          {/* Education & Skills */}
          <div className="space-y-4">
            <h2 className="text-lg text-primary font-medium">Education & Skills</h2>
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
                control={form.control}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Press Enter to separate skills" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          {/* Resume & Cover Letter */}
          <div className="space-y-4">
            <h2 className="text-lg  text-primary font-medium">Resume & Cover Letter</h2>
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
                control={form.control}
                name="resume"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Describe your feedback here..." className="min-h-[100px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <Button type="submit" className="w-full bg-[#3E9B8B] hover:bg-[#328073]">
            Submit Application
          </Button>
        </form>
      </Form>
