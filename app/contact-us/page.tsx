...
export const metadata = mergeMetadata ( {
  ...
  description: "Contact Biz Marine for all your marine parts inquiries. We're here to help with expert advice and top-tier customer support.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Contact Us - Biz Marine | Get In Touch",
    description: "Reach out to Biz Marine for assistance with marine parts. We're ready to provide reliable support for all your maritime needs.",
    url: "/contact-us",
    locale: "en_us",
    siteName: "Biz Marine",
  },
...
const ContactUs = () => {
  return (
    <>
      <MarineBreadCrumb />
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 content-start p-5 md:py-10">
       ...
       <div
        className="w-full relative flex flex-col gap-4 md:gap-4 h-auto "
      >
        ...
        <span className="w-full relative h-auto flex flex-col gap-1 ">
          <h2 className="w-full  text-lg  lg:text-2xl font-medium text-webtext  ">
            Address :
          </h2>
