...
const RetunAndRefundPolicy = () => {
  return (
    <>
      <CommonBanner
        title="Return and Refund Policy"
        image={"/bizmarinePrivacypolicy.jpg"}
      />
      <MarineBreadCrumb />
      <div className="w-full realtive h-auto biz__container  py-10">
        <p className="text-semnibold text-lg text-primnary">
        ...
        <span className="flex flex-col gap-4 w-full relative h-auto mt-10">
          ...
          <ul className="w-full relative flex flex-col gap-2 list-disc  h-auto px-5 ">
            <li className="text-base font-normal  text-primnary">
...
export default RetunAndRefundPolicy;
